...
class Login extends Component
{
    ...
    public function login()
    {
        ...
        try {
            ...
            // Only reset Turnstile if the error is NOT related to Turnstile itself
            // This prevents "timeout-or-duplicate" when validation fails on other fields (e.g. password)
            // because the token is still valid for a short time or needs to be re-generated by the user anyway
            if (!isset($e->errors()['turnstileToken'])) {
                $this->dispatch('reset-turnstile');
            }
            throw $e;
        }
