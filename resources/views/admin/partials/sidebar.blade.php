<aside class="fixed left-0 top-16 w-64 h-full bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out z-40" id="sidebar">
    <nav class="mt-6 px-3 space-y-1">
        <a href="{{ route('admin.dashboard') }}" wire:navigate class="group flex items-center px-3 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' }} transition ease-in-out duration-150">
        ...
        <a href="{{ route('admin.questions.index') }}" wire:navigate class="group flex items-center px-3 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.questions.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' }} transition ease-in-out duration-150">
