    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Create New Question</h1>
                <p class="text-gray-600 mt-1">Add a new challenge for the GIS game.</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 ml-11">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g. Find the Hidden Treasure" 
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4" placeholder="Provide a detailed description or hint for the user..." 
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4 text-gray-900 placeholder-gray-400 @error('description') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-red-600 text-sm mt-1 flex items-center"><span class="material-icons text-sm mr-1">error</span> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 ml-11">
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" step="any" name="answer_latitude" id="answer_latitude" value="{{ old('answer_latitude') }}" placeholder="0.000000"
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" step="any" name="answer_longitude" id="answer_longitude" value="{{ old('answer_longitude') }}" placeholder="0.000000"
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    <input type="number" name="tolerance_meters" id="tolerance_meters" value="{{ old('tolerance_meters', 50) }}" placeholder="50"
