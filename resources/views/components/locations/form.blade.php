    ...
    <div class="card-body">
        <form action="{{ $action }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-white text-dark border-secondary" id="name" name="name" 
            ...
            <div class="mb-3">
                ...
                <input type="number" step="any" class="form-control bg-white text-dark border-secondary" id="latitude" 
            ...
            <div class="mb-3">
                ...
                <input type="number" step="any" class="form-control bg-white text-dark border-secondary" id="longitude" 
